        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="nav-label">Thiết lập dữ liệu</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Thiết lập dữ liệu</span>
                        </a>
                    ...
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Nhà cung cấp</span>
                        </a>
                    </li>

                    <li class="nav-label">Dữ liệu nhập xuất</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-envelope menu-icon"></i> <span class="nav-text">Dữ liệu nhập hàng</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="#">Nhập hàng</a></li>
                            <li><a href="#">Sản phẩm đã nhập</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-screen-tablet menu-icon"></i><span class="nav-text">Dữ liệu xuất hàng</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="#">Xuất hàng</a></li>
                            <li><a href="#">Sản phẩm đã xuất</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Dữ liệu kho hàng</span>
                        </a>
                    </li>

                    <li class="nav-label">Báo cáo thống kê</li>
                    <li>
                        <a href="widgets.html" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Thống kê nhập xuất tồn đầu</span>
                        </a>
                    </li>
                    <li>
                        <a href="widgets.html" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Thống kê doanh thu</span>
                        </a>
                    </li>
                    <li>
                        <a href="widgets.html" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Thống kê SL hàng bán ra</span>
                        </a>
                    </li>

                    <li class="nav-label">Thông tin quản trị</li>
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Danh sách người dùng</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Tạo người dùng</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Phân quyền người dùng</span>
                        </a>
                    </li>
                </ul>
            </div>
